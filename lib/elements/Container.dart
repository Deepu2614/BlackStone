...
class _ContainerBoxState extends State<ContainerBox> {
  ...
  Future<void> deleteItem(String id) async {
    final response = await http.delete(
      Uri.parse("https://64e2ef8cbac46e480e77edd9.mockapi.io/order/$id"),
    );
                                                ...
                                                children: [
                                                  Expanded(
                                                    ...
                                                    child: MaterialButton(
                                                      onPressed: () async {
                                                        // Call the deleteItem method and pass the item's id
                                                        await deleteItem(dataList[index]["id"]);
                                                        Navigator.of(context).pop();
                                                        // Refresh the data or update the UI after deletion
                                                        _refreshData();
                                                      },
                                                      child: Text(
                                                        "Confirm",
